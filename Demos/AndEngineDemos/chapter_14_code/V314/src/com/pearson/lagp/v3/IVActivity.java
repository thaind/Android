  ...
  public static String trimQuotes( String value )
  {
    ...
    return value;
     ...
     private void mGameOver(boolean pWin){
    	 ...
    	 if (pWin){
    		 scene.setChildScene(mCreateEndScene(true, "Congratulations!!"), false, true, true);
    	 } else {
    		 scene.setChildScene(mCreateEndScene(false, "You're Out of Stakes!"));
    	 }
     }
     
     private Scene mCreateEndScene(boolean pWin, String pTitle){
