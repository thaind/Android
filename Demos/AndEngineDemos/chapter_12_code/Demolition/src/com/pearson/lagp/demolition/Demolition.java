...
public class Demolition extends BaseGameActivity implements IAccelerometerListener, IOnSceneTouchListener {
		// ===========================================================
		// Constants
		// ===========================================================
		...
		public void onLoadResources() {
			...
			/* TextureRegions. */
			mTStoneTextureRegion = TextureRegionFactory.createFromAsset(mTexture, getApplicationContext(), "tombstone.png", 0, 0); // 50x50
			mMatHeadTextureRegion = TextureRegionFactory.createFromAsset(mTexture, getApplicationContext(), "mathead.png", 0, 50); // 32x32
		...
		private void addBody(final float pX, final float pY) {
			...
			if(mBodyCount % 2 == 0) {
				newSprite = new Sprite(pX, pY, mTStoneTextureRegion);
				body = PhysicsFactory.createBoxBody(mPhysicsWorld, newSprite, BodyType.DynamicBody, FIXTURE_DEF);
			} else {
				newSprite = new Sprite(pX, pY, mMatHeadTextureRegion);
				body = PhysicsFactory.createCircleBody(mPhysicsWorld, newSprite, BodyType.DynamicBody, FIXTURE_DEF);
			}
