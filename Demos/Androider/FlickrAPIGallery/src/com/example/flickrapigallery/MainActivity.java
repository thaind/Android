package com.example.flickrapigallery;
...
public class MainActivity extends Activity {
	...
	String FlickrQuery_per_page = "&per_page=50";
	...
	private Button.OnClickListener searchButtonOnClickListener = new Button.OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			photoBar.setAdapter(new FlickrAdapter(MainActivity.this,
					myFlickrImage));
			Toast.makeText(MainActivity.this, "Bấm rồi chờ 1 tí", Toast.LENGTH_LONG).show();
		}
	};
