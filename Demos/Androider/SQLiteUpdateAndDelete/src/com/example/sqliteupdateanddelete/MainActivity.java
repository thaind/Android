package com.example.sqliteupdateanddelete;
...
public class MainActivity extends Activity {
	...
	private ListView.OnItemClickListener listContentOnItemClickListener = new ListView.OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			buildDialog(item_id, item_content1, item_content2);

		}

		private void buildDialog(final int item_id, String item_content1,
			...
			myDialog.setNeutralButton("Update",
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface arg0, int arg1) {
							...
							mySQLiteAdapter
									.update_byID(item_id, value1, value2);
							updateList();
						}
					});
