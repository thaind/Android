package com.example.skewbitmapimageusingmatrix;
...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		seekbarSkewX
				.setOnSeekBarChangeListener(seekbarSkewXSeekBarChangeListener);
		seekbarSkewY
				.setOnSeekBarChangeListener(seekbarSkewYSeekBarChangeListener);
	}
	...
	private SeekBar.OnSeekBarChangeListener seekbarSkewYSeekBarChangeListener = new SeekBar.OnSeekBarChangeListener() {
	...
	private SeekBar.OnSeekBarChangeListener seekbarSkewXSeekBarChangeListener = new SeekBar.OnSeekBarChangeListener() {
